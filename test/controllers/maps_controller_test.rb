...
class MapsControllerTest < ActionController::TestCase
  ...
  test "should create map" do
    assert_difference('Map.count') do
      post :create, map: { center_lat: @map.center_lat, center_lon: @map.center_lon, name: @map.name, zoom: @map.zoom }
    end
  ...
  test "should update map" do
    patch :update, id: @map, map: { center_lat: @map.center_lat, center_lon: @map.center_lon, name: @map.name, zoom: @map.zoom }
    assert_redirected_to map_path(assigns(:map))
  end
